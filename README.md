...
1) Fork the following repo https://github.com/kamehta4/rosa-idp.git to your github repo.
...
The deploy.sh script does 3 things:
   ...
   * Modify all files at argocd/applications/templates so they point to the forked repo instead of kamehta4
